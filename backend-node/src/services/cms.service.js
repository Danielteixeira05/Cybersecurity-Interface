...
export const SITE_CONTENT_DEFINITIONS = Object.freeze({
  ...
  homepage_servicos_cabecalho: { page: 'homepage', repeatable: false },
  'homepage.servico.pentesting': { page: 'homepage', repeatable: false },
  'homepage.servico.incidentes-nis2': { page: 'homepage', repeatable: false },
  'homepage.servico.conformidade-nis2': { page: 'homepage', repeatable: false },
  'homepage.servico.siem': { page: 'homepage', repeatable: false },
  'homepage.servico.formacao': { page: 'homepage', repeatable: false },
  'homepage.servico.cloud-devsecops': { page: 'homepage', repeatable: false },
  homepage_cta_final: { page: 'homepage', repeatable: false },
