...
import { assessments, assets, documents, incidents, requests } from './controllers/resources.controller.js';
...
app.get('/api/pedidos/', authenticate, requests);
app.get('/api/avaliacoes', authenticate, assessments);
app.use(notFound);
